...
> **An AI‑based Anti‑Phishing Email Detector that analyzes email content, headers, and links to identify phishing attacks, calculate risk scores, store history, and visualize ML evaluation results.**
